...
function calcularFiscalOrden(
  ...
  // ratio = fracción que representa esta venta sobre la facturación total del mes
  ...
  // Recibido de ML: lo que ML te transfiere literalmente (igual que antes)
  const recibidoML = totalBruto + envioCobradoCliente - cargosML - retenciones + bonificacionEnvio
  // Recibido neto después del costo Flex propio
  const recibidoNeto = recibidoML - costoFlexEstimado

  // Ganancia operativa (sin IVA, sin IIBB pendiente) - igual que antes
